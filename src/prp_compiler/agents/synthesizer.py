...
detailed Product Requirement Prompt (PRP) as a single, valid JSON object that
strictly conforms to the provided JSON schema. Do not output any text or
explanation outside of the JSON object itself.
...
class SynthesizerAgent(BaseAgent):
    ...
    f"Please correct the JSON output to strictly conform to the schema."
        ...
        raise RuntimeError(
            (
    "Synthesizer failed to produce a valid PRP JSON after multiple attempts."
)
        )
