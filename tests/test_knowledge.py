...
def test_knowledge_store_build_and_retrieve(tmp_path):
    ...
    with patch("src.prp_compiler.knowledge.GoogleGenerativeAIEmbeddings") as mock_embeddings, \
        ...
        # Test retrieve
        mock_chroma_inst.similarity_search.return_value = [MagicMock(page_content="ChunkA"), MagicMock(page_content="ChunkB")]
