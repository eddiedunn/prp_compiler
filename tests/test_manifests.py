...
def test_save_manifest(temp_capability_dir):
    ...
    tools_manifest = [
        ManifestItem(name="tool1", description="desc1", file_path="path1")
    ]
    knowledge_manifest = [
        ManifestItem(name="knowledge1", description="desc2", file_path="path2")
    ]
    schemas_manifest = [
        ManifestItem(name="schema1", description="desc3", file_path="path3")
    ]
