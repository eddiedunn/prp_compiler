...
def test_run_planning_loop_calls_finish(monkeypatch):
    ...
    # Mock responses
    retrieve_response = make_mock_gemini_response('retrieve_knowledge', {"query": "test query", "reasoning": "r1", "criticism": "c1"})
    finish_response = make_mock_gemini_response('finish', {"schema_choice": "standard_prp", "pattern_references": ["pattern1"], "reasoning": "r2", "criticism": "c2"})
